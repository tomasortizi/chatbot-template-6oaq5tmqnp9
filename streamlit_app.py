...
pie_uf = st.number_input("¿Cuánto pie puedes pagar en UF?", min_value=0, step=0.1)
dividendo_clp = st.number_input("¿Cuánto dividendo esperas pagar mensualmente en CLP?", min_value=0, step=10000)
